...
class RoutineDTOTests: XCTestCase {
    ...
    func testPresentableRoutineConversion() {
        ...
        let routine1 = RoutineDTO(startTime: startTime1, endTime: endTime1, color: "")
        ...
        let routine2 = RoutineDTO(startTime: startTime2, endTime: endTime2, color: "")
        ...
        let routine3 = RoutineDTO(startTime: startTime3, endTime: endTime3, color: "")
        ...
        let routine4 = RoutineDTO(startTime: startTime4, endTime: endTime4, color: "")
